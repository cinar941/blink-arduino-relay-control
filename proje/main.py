...
voice_left = mixer.Sound('C:/Users/MEHMET/Desktop/pyprogramlama/Voice/left.wav')
voice_right = mixer.Sound('C:/Users/MEHMET/Desktop/pyprogramlama/Voice/Right.wav')
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            if ratio >4.5:
                ...
                if TOTAL_BLINKS==4:
                    byte_command=encode(user_input1)
                    ser.writelines(byte_command)
                if TOTAL_BLINKS==6:
                    TOTAL_BLINKS=0
          ...
          #  cv.putText(frame, f'Total Blinks: {TOTAL_BLINKS}', (100, 150), FONTS, 0.6, utils.GREEN, 2)
            ...
            if eye_position_right=="RIGHT" and pygame.mixer.get_busy()==0 :
                ...
                counter_right+=1
                if counter_right==2:
                    byte_command =encode (user_input2)
                    ser.writelines(byte_command)
                if counter_right==4:
                    byte_command=encode(user_input3)
                    ser.writelines(byte_command)
                if counter_right==6:
                    counter_right=0
                print(f"right {0}",counter_right)
                voice_right.play()
            ...
            if eye_position_right=="LEFT" and pygame.mixer.get_busy()==0 : 
                counter_left +=1
                if counter_left==2:
                    byte_command =encode (user_input4)
                    ser.writelines(byte_command)
                if counter_left==4:
                    byte_command=encode(user_input5)
                    ser.writelines(byte_command)
                if counter_left==6:
                    counter_left=0
                voice_left.play()
                print(f"left {0}",counter_left)
